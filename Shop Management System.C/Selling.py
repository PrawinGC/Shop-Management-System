...
def sell():
    ...
    valid_id = int(input("Please provide the id of the laptop that you want to sell : "))
    ...
    mydict[valid_id][3] = str(int(get_quantity) - int(user_quantity))
    while user_quantity <= 0 or user_quantity > get_quantity:
            print("\n************************************************************************")
            print("      ****Laptop is out of stock !!****     ")
            print("\n************************************************************************")
    mydict[valid_id][3] = str(int(get_quantity) - int(user_quantity))
    delivery_cost = input("Do you want us to deliver your product?(y/n): ").lower()
    ...
    if delivery_cost == "y":
         ...
         print("\n************************************************************************")
         print("              ****Your laptop has already been packed. ****               ")
         print("************************************************************************\n")

    else:
         print("\n************************************************************************")
         print("Your Laptop  will not be Delivered")
         print("\n************************************************************************")
    ...
    if Track_order == "y":
            print("\n************************************************************************")
            print("              Your product has picked by one of you delivery Agent             ")
            print("************************************************************************\n")
